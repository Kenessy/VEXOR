...
$env:TP6_LR = "0.01"
$env:TP6_DOMAIN_SEP_COEFF = "0.1"

# Biology enabled
$env:TP6_MITOSIS = "1"
$env:TP6_MITOSIS_CKPT = "checkpoints/mitosis/tier4_mix_mitosis_sentinel_round13.pt"
$env:TP6_MITOSIS_STALL_WINDOW = "50"
$env:TP6_MITOSIS_IMBALANCE = "0.2"
$env:TP6_MITOSIS_STALL_DELTA = "0.0"
$env:TP6_METABOLIC_HUNGER = "0"
$env:TP6_METABOLIC_TELEMETRY = "0"
$env:TP6_METABOLIC_COST_COEFF = "0"
$env:TP6_METABOLIC_EVERY = "100"

# Runtime limit (run until manually stopped)
$env:TP6_WALL = "600"
...
# Logging
$env:VAR_LOGGING_PATH = "logs/tier4_phase_b_sentinel_resume.log"
...
Write-Host ">>> Tier4 Phase B (assoc_mix + safe sentinel + biology) starting" -ForegroundColor Green
